...
export const addUserInGroup = (uid, gid) => groupsModel.updateOne({_id: gid},{"$push": {"userIds": uid} });
...
export const deleteUserFromGroup = (uid, gid) => groupsModel.updateOne({_id: gid}, {"$pull": {"userIds": uid}});